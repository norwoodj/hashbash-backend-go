...
type RainbowTable struct {
	...
	GenerateStarted   *time.Time `gorm:"column:generateStarted"json:"generateStarted"`
	GenerateCompleted *time.Time `gorm:"column:generateCompleted"json:"generateCompleted"`
